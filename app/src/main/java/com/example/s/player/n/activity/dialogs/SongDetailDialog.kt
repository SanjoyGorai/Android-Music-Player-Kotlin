...
import com.example.s.player.databinding.DialogFileDetailsBinding
import com.example.s.player.n.activity.EXTRA_SONG
import com.example.s.player.n.activity.colorButtons
...
class SongDetailDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val song = BundleCompat.getParcelable(requireArguments(), EXTRA_SONG, Music::class.java)
        with(binding) {
...
//                )
    ...
    companion object {
        ...
        fun create(song: Music): SongDetailDialog {
