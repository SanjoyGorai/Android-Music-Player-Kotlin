...
package sql.db.appthemehelper.common.prefs.supportv7.dialogs;
...
public class ATEPreferenceDialogFragment extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!(rawFragment instanceof androidx.preference.DialogPreference.TargetFragment)) {
            ...
            androidx.preference.DialogPreference.TargetFragment fragment = (androidx.preference.DialogPreference.TargetFragment) rawFragment;
